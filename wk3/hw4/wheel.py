...
class Wheel():
    ...
    '''
	win - GraphWin object
	dx/dy - the units by which to move an object in x and y directions
	n - the number of times to call the animate method 
    ...
    def animate(self, win, dx, dy, n):
		if n > 0:
			...
			'''
			- after method - 
			100 - time(milliseconds) after which the GraphWin object
			      will call the animate method again
			self.animate - the function object the GraphWin object
			               needs to call
			remaining parameters - for the animate (this) method
			'''
